...
export function Dropdown({title, logo, submitFn, }: DropdownProps){
    ...
    return (
        <div className="relative">
            ...
            {
                isMenuVisible ? <DropdownMenu ref={menuRef} options={options} submitFn={submitFn} className="border border-border-color w-52 right-0 top-12"/>
                :
                null
